...
$yi=0;
	...
	if(true){
		...
		$pdf->addJpegFromFile('images/logo.jpg',30,755,50,60);//		$pdf->selectFont(FONTS_URL.'Courier.afm');
	}
	//Curvas - Cuerpo
	...
	$pdf->addText($x+63,$y-15,10,"<b>Año</b>");
	...
	$pdf->addText($clix,$cliy-70,$cliz,"<i><b>Sirva(n)se cotizarnos PRECIOS NETOS incluidos los impuestos de los siguientes ITEMS  que se detallan a continuacion: </b></i>");
...
//	$pdf->line($clix-20,$cliy+30,$clix+535,$cliy+30);
	...
	$pdf->addText($clix+20,$cliy-120,$cliz,"Firma de Autorizacion");
