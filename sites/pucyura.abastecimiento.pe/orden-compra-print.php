...
$cliente=($orden['proveedor']['razonsocial'])."</i>";
...
$cant="";
$und="";
$detalle=($orden['detalle'][$inde]['descripcion']);
...
$pdf->addText($notx,$noty-$notw,$notz,utf8_decode("mercadería que no está de acuerdo con nuestras "));
