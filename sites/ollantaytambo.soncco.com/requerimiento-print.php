...
$inde=$inde+1;
$datadet[$yi] = array('nro'=>$nro,'cant'=>$cant,'und'=>$und,'detalle'=>$detalle);
}
...
$pdf->addText($x+5,$y-15,10,utf8_decode("Dia"));
$pdf->addText($x+30,$y-15,10,"Mes");
$pdf->addText($x+63,$y-15,10,("Año"));
...
$pdf->addText($clix+320,$cliy-17,$cliz,"<b>Meta : .....................................</b>");
...
$pdf->addText($clix+40,$cliy-50,$cliz,"Solicitante");
$pdf->line($clix+10,$cliy-40,$clix+128,$cliy-40);
$pdf->addText($clix+210,$cliy-50,$cliz,"Jefe de Abastecimiento");
$pdf->line($clix+200,$cliy-40,$clix+305,$cliy-40);
$pdf->addText($clix+30,$cliy-120,$cliz,"Firma de Supervisor/");
$pdf->addText($clix+35,$cliy-129,$cliz,"Jefe de Unidad");
$pdf->line($clix+10,$cliy-110,$clix+128,$cliy-110);
$pdf->addText($clix+205,$cliy-120,$cliz,"Gerencia de Administracion");
$pdf->line($clix+200,$cliy-110,$clix+305,$cliy-110);
$pdf->addText($clix+380,$cliy-120,$cliz,"Gerencia Municipal");
...
$pdf->line(101,655,101,165);//V1
$pdf->line(42,655,42,165);//V1
$pdf->line(175,655,175,165);//V1
