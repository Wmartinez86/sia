...
$cliy=729;
$cliz=8;
$pdf->addText($clix,$cliy,$cliz,utf8_decode("<b>SEÑOR(ES): </b><i>".$cliente."</i>"));
...
$pdf->addText($notx,$noty-$notw,$notz,utf8_decode("Servicio que no está de acuerdo con nuestras "));
