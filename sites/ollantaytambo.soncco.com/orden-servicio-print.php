...
'detalle'=>array('justification'=>'left','width'=>269),
...
$totalidad=0;
foreach($orden['detalle'] as $k => $detail) {
$totalidad += $detail['precio']*$detail['cantidad'];
}
$rowsdif=$rowsdif;
if(($rowsdif %26)!=0){
...
$pdf->line(99,604,99,288);//V1
$pdf->line(153,604,153,288);//V1
$pdf->line(193,604,193,288);//V1
...
$pdf->addText(226,699,15,"<b>ORDEN DE SERVICIO</b>");
//Fecha de la Orden
$x=506;$y=749;
$x=$x-15;
...
$pdf->addText(30,593,$zin,"<b>CODIGO</b>");
$pdf->addText(110,593,$zin,"<b>CANT.</b>");
$pdf->addText(155,593,$zin,"<b>U.MED</b>");
$pdf->addText(290,593,$zin,"<b>DESCRIPCION</b>");
...
$pdf->addText($notx,$noty+$notw*5,$notz,"Cada Orden de Servicio se debe facturar");
...
$pdf->addText($notx,$noty,$notz,"Nos reservamos el derecho de aceptar el");
$pdf->addText($notx,$noty-$notw,$notz,utf8_decode("Servicio que no está de acuerdo con"));
...
$prey=203;
$prez=10;
$pdf->addText($prex,$prey+48,$prez,"<b>Sec_Func :</b>  ".$sec_func."  ");
$pdf->addText($prex,$prey+35,$prez,"<b>Fte_Fto     :</b>  ".$fte."  ");
$pdf->addText($prex,$prey+24,$prez,"<b>Cad_Func :</b>  ".$cad_fun."  ");
...
//RECIBI CONFORME
$pdf->addText(458,110,9,"<b>VoBo DEL SERVICIO</b>");
