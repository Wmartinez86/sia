...
$procedencia = "<i> ".($nea['procedencia'])."</i>";
...
if($nea['idorden']==0){
    ...
    $segun = "<i> Orden de Compra  Nro. : ".$orden['codigo']."</i>";
}
//lineas
...
$cliy=729;
$cliz=8;
$pdf->addText($clix,$cliy,$cliz,utf8_decode("<b>PROCEDENCIA: </b><i>".$procedencia."</i>"));
$pdf->addText($clix,$cliy-14,$cliz,"<b>CON DESTINO A : </b><i>".$destino."</i>");
$pdf->addText($clix,$cliy-28,$cliz,"<b>SEGUN: </b><i>".$segun."</i>");
//Titulos Cuerpo
$zin="10";
...
$py=100;
$pz=8;
$pdf->addText($px+80,$py-54,$pz,"<i>FIRMA</i>");
