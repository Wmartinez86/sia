...
//		$pdf->addText($clix+120,$cliy-20,10,"<b>Pagina </b>.".$xi." de ".($count+1));
	...
	$pdf->addText($tx+6,$ty+340,$tf,utf8_decode("<b>Cotización Nro: </b><i>".$cot['codigo']."</i>"));
	$pdf->addText($tx+6,$ty+325,$tf,"<b>Referencia: </b><i>".substr(utf8_decode($cot['referencia']),0,40)."</i>");
	$pdf->addText($tx+6,$ty+310,$tf,utf8_decode("<b>Cotización elaborada el: </b><i>".$cot['fecha']."</i>"));
