...
$pdf->addText(226,750,15,"<b>ORDEN DE SERVICIO</b>");
//Fecha de la Orden
$x=489;$y=800;
$x=$x-15;
...
$cliy=729;
$cliz=8;
$pdf->addText($clix,$cliy,$cliz,"<b>SEÑOR(ES): </b><i>".$cliente."</i>");
...
$pdf->addText($notx,$noty+$notw*5,$notz,"Cada Orden de Servicio se debe facturar por ");
...
$pdf->addText($notx,$noty,$notz,"Nos reservamos el dereho de aceptar el");
$pdf->addText($notx,$noty-$notw,$notz,"Servicio que no esta de acuerdo con nuestras ");
...
$prey=204;
$prez=9;
$pdf->addText($prex,$prey+48,$prez,"<b>Sec_Func :</b><i>".$sec_func."</i>");
$pdf->addText($prex,$prey+35,$prez,"<b>Fte_Fto :</b><i>".$fte."</i>");
$pdf->addText($prex,$prey+24,$prez,"<b>Cad_Func :</b><i>".$cad_fun."</i>");
$pdf->addText($prex,$prey+12,$prez,"<b>Meta :</b><i>".substr($descripcion,0,50)."-</i>");
$pdf->addText($prex,$prey,$prez,"".substr($descripcion,50,65).".</i>");

$pdf->addText($prex+62,$prey+46,$prez,".................................");
$pdf->addText($prex+62,$prey+33,$prez,".................................");
$pdf->addText($prex+62,$prey+22,$prez,".................................");
$pdf->addText($prex+62,$prey+10,$prez,"..........................................................................................");
